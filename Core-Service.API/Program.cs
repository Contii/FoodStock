...
builder.Services.AddCors(options =>
{
    ...
    {
        builder.WithOrigins("http://localhost:8162") //.AllowAnyOrigin() // .WithOrigins("http://localhost:8162", "http://localhost:8163") // frontend URL
               .AllowAnyMethod()
               .AllowAnyHeader();
    });
});
...
app.Urls.Add("http://localhost:8172");
